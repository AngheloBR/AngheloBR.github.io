...
(function () {
    ...
    const es = {
        ...
        'why.4.t': 'Registro', 'why.4.p': 'Cada comando, por qué se ejecutó y cómo deshacerlo. Si algún día migras de proveedor, puedes repetir todo tú mismo.',
        ...
        'step.2.m': '1–4 h, según plan', 'step.3.m': 'con la entrega · 1–3 días', 'step.3.t': 'Reporte', 'step.3.p': 'Un PDF con cada comando, por qué se ejecutó y cómo revertirlo (Basic recibe un resumen en texto). Premium incluye 14 días de soporte por si algo se comporta raro después.',
        ...
        'tier.basic.time': '~1.5 h de trabajo', 'tier.basic.eta': 'entrega en 1 día',
        'tier.std.time': '~3 h de trabajo', 'tier.std.eta': 'entrega en 2 días',
        'tier.prem.time': '~5 h de trabajo', 'tier.prem.eta': 'entrega en 3 días',
        ...
        'tier.flag': 'El más pedido', 'tier.cta': 'Pedir en Fiverr',
        ...
        'feat.std': 'Todo lo de Standard', 'feat.audit': 'Auditoría Lynis antes y después, con puntaje',
        'feat.ids': 'rkhunter + auditd', 'feat.logwatch': 'Resumen diario de logwatch por email',
        'feat.tls': 'Reverse proxy Nginx/Caddy con TLS (Let\'s Encrypt)', 'feat.2fa': '2FA para SSH (TOTP), opcional',
        'feat.warranty': '14 días de soporte post-entrega',
        'extras.title': 'Extras', 'extra.server': 'Servidor adicional', 'extra.express': 'Entrega express en 24 h',
        'extra.lynis': 'Auditoría Lynis suelta', 'extra.mo': '/mes', 'extra.maint': 'Mantenimiento mensual: updates, revisión de logs, re-auditoría',
